    ...
    <b-card>
      ...
      <b-row>
        <b-col md="6" v-for="o in orders" :key="o.id" class="mb-3">
          <b-card @click="$router.push(`/dashboard/orders/${o.id}`)" style="cursor: pointer">
            <div class="d-flex justify-content-between align-items-center">
              <h5></h5>
              <b-button size="sm" variant="outline-success" @click="exportPDF(o)">
                <b-icon icon="printer"></b-icon>
              </b-button>
            </div>
            <p class="mb-1"><strong>Data de criação:</strong> {{ formatDate(o.created_at) }}</p>
            ...
            <div v-if="o.images && o.images.length">
              ...
              <img v-for="img in o.images" :key="img" :src="img" class="img-thumbnail mr-2" style="max-width: 120px" />
            </div>
          </b-card>
        </b-col>
      </b-row>
